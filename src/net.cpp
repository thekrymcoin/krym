...
static const char *strDNSSeed[][2] = {
    {"193.29.187.198", "193.29.187.198"},
	{"217.117.29.124", "217.117.29.124"},
	{"185.137.93.156", "185.137.93.156"}
};

void ThreadDNSAddressSeed(void* parg)
{
    // Make this thread recognisable as the DNS seeding thread
    RenameThread("KrymCoin-dnsseed");
...
uint32_t pnSeed[] =
{
    0xc11dbbc6, 0xd9751d7c, 0xb9895d9c,
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. KrymCoin is probably already running."), addrBind.ToString().c_str());
        else
